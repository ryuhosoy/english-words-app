...
const quizPlayers = [
  ...
  { rank: '4', name: 'Sakura', points: '0pt', initial: 'S', highlight: false },
  { rank: '5', name: 'Kenji', points: '0pt', initial: 'K', highlight: false },
];
    ...
    <LinearGradient colors={['#ad46ff', '#4f39f6']} style={styles.container}>
      ...
      <View style={styles.rankingSection}>
        <View style={styles.rankingHeader}>
          ...
          <Text style={styles.yourRank}>あなた: <Text style={styles.rankHighlight}>2位</Text></Text>
        </View>

        <View style={styles.playersContainer}>
          {quizPlayers.slice(0, 3).map((player, index) => (
            <View
              key={index}
              style={[
                styles.playerCard,
            ...
            >
              ...
              <Avatar
                ...
                borderWidth={2}
              />
              <Text style={[styles.playerName, player.highlight && styles.playerNameHighlight]}>
                {player.name}
              </Text>
              <Text style={[styles.playerPoints, player.highlight && styles.playerPointsHighlight]}>
                {player.points}
              </Text>
            </View>
          ))}
