        ...
        <Card style={styles.resultCard}>
          ...
          <View style={styles.statsRow}>
            ...
            <View style={styles.statItem}>
              ...
              <Text style={styles.statValueBlue}>{correctAnswers}/{totalQuestions}</Text>
            </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 36, color: '#ffffff', fontWeight: '400', textAlign: 'center', letterSpacing: 0.37 },
  subtitle: { fontSize: 18, color: '#ffffffe6', fontWeight: '400', textAlign: 'center', letterSpacing: -0.44 },
  resultCard: { gap: 30, shadowColor: '#000', shadowOffset: { width: 0, height: 25 }, shadowOpacity: 0.25, shadowRadius: 50, elevation: 20 },
  scoreLabel: { fontSize: 16, color: '#45556c', textAlign: 'center', letterSpacing: -0.31 },
  scoreValue: { fontSize: 60, color: '#0e162b', fontWeight: '400', textAlign: 'center', letterSpacing: 0.26 },
  statsRow: { flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 20 },
  statItem: { alignItems: 'center' },
  statLabel: { fontSize: 14, color: '#45556c', textAlign: 'center', letterSpacing: -0.15 },
  statValue: { fontSize: 24, color: '#00a63d', fontWeight: '400', textAlign: 'center', letterSpacing: 0.07 },
  statValueBlue: { fontSize: 24, color: '#155cfb', fontWeight: '400', textAlign: 'center', letterSpacing: 0.07 },
  divider: { width: 1, height: 40, backgroundColor: '#e2e8f0' },
  starsSection: { alignItems: 'center', gap: 10 },
  starsLabel: { fontSize: 14, color: '#45556c', textAlign: 'center', letterSpacing: -0.15 },
  ...
  homeButton: { backgroundColor: '#ffffff33', borderColor: '#ffffff4c', borderWidth: 1, height: 45 },
  homeButtonText: { color: '#ffffff', fontSize: 14 },
  footerText: { fontSize: 14, color: '#ffffffcc', textAlign: 'center', letterSpacing: -0.15 },
});
